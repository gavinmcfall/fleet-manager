...
### Report bugs
Use the [Bug Report template](https://github.com/SC-Bridge/sc-bridge/issues/new?template=01-bug-report.yml). Include reproduction steps, your browser, and a screenshot if possible.

### Suggest features
[Ideas](https://github.com/SC-Bridge/sc-bridge/discussions/categories/ideas) in Discussions is the right place. Upvote existing ideas before posting a new one.
