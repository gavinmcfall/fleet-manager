      ...
      <PanelSection title="Get the Extension" icon={Download} id="get-the-extension">
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-center gap-2 p-3 rounded bg-amber-500/10 border border-amber-500/20">
            ...
            <span className="text-sm text-amber-400">Browser store listings coming soon</span>
            <span className="ml-auto text-[10px] font-mono px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/20 text-amber-400 uppercase tracking-wider">Coming Soon</span>
          </div>

          {/* Manual install */}
          <div className="space-y-3">
            <h4 className="text-xs font-medium text-gray-400 uppercase tracking-wider">Manual Install</h4>
            <p className="text-xs text-gray-500">
              Download the extension for your browser and install it manually. Store listings will be available once approved.
            </p>

            <div className="space-y-2">
              <details className="group">
                <summary className="flex items-center justify-between p-3 rounded border border-sc-border hover:border-sc-accent/30 transition-colors cursor-pointer select-none">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-300 group-open:text-white transition-colors">Chrome / Brave / Arc</span>
                  </div>
                ...
                <div className="px-3 pb-3 pt-2 space-y-2">
                  ...
                  <ol className="space-y-1 text-xs text-gray-400 list-decimal list-inside">
                    ...
                    <li>Open <span className="font-mono text-gray-300">chrome://extensions</span></li>
                    <li>Enable <span className="text-white">Developer mode</span> (top right)</li>
                    <li>Click <span className="text-white">Load unpacked</span> and select the unzipped folder</li>
                  </ol>
                </div>
              </details>
              ...
              <details className="group">
                <summary className="flex items-center justify-between p-3 rounded border border-sc-border hover:border-sc-accent/30 transition-colors cursor-pointer select-none">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-300 group-open:text-white transition-colors">Firefox</span>
                  </div>
                  <ChevronDown className="w-4 h-4 text-gray-500 group-open:rotate-180 transition-transform" />
                </summary>
                <div className="px-3 pb-3 pt-2 space-y-2">
                  ...
                  <ol className="space-y-1 text-xs text-gray-400 list-decimal list-inside">
                    <li>Open <span className="font-mono text-gray-300">about:debugging#/runtime/this-firefox</span></li>
                    <li>Click <span className="text-white">Load Temporary Add-on</span></li>
                    <li>Select the downloaded zip file (no need to unzip)</li>
                  </ol>
                  <p className="text-[10px] text-gray-600">Note: Temporary add-ons are removed when Firefox closes.</p>
                </div>
              </details>
              ...
              <details className="group">
                <summary className="flex items-center justify-between p-3 rounded border border-sc-border hover:border-sc-accent/30 transition-colors cursor-pointer select-none">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-300 group-open:text-white transition-colors">Edge</span>
                  </div>
                  <ChevronDown className="w-4 h-4 text-gray-500 group-open:rotate-180 transition-transform" />
                </summary>
                <div className="px-3 pb-3 pt-2 space-y-2">
                  ...
                  <ol className="space-y-1 text-xs text-gray-400 list-decimal list-inside">
                    <li>Unzip the downloaded file</li>
                    <li>Open <span className="font-mono text-gray-300">edge://extensions</span></li>
                    <li>Enable <span className="text-white">Developer mode</span> (bottom left)</li>
                    <li>Click <span className="text-white">Load unpacked</span> and select the unzipped folder</li>
                  </ol>
                </div>
              </details>
              ...
              <details className="group">
                <summary className="flex items-center justify-between p-3 rounded border border-sc-border hover:border-sc-accent/30 transition-colors cursor-pointer select-none">
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="#FF1B2D" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 1.2A10.8 10.8 0 0122.8 12 10.8 10.8 0 0112 22.8 10.8 10.8 0 011.2 12 10.8 10.8 0 0112 1.2zm0 2.4a8.4 8.4 0 100 16.8 8.4 8.4 0 000-16.8z"/></svg>
                    <span className="text-sm text-gray-300 group-open:text-white transition-colors">Opera</span>
                  </div>
                  <ChevronDown className="w-4 h-4 text-gray-500 group-open:rotate-180 transition-transform" />
                </summary>
                <div className="px-3 pb-3 pt-2 space-y-2">
                  ...
                  <ol className="space-y-1 text-xs text-gray-400 list-decimal list-inside">
                    <li>Unzip the downloaded file</li>
                    <li>Open <span className="font-mono text-gray-300">opera://extensions</span></li>
                    <li>Enable <span className="text-white">Developer mode</span> (top right)</li>
                    <li>Click <span className="text-white">Load unpacked</span> and select the unzipped folder</li>
                  </ol>
                </div>
