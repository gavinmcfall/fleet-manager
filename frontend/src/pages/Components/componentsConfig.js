...
export const COLUMNS = {
  ...
  missile: [
    NAME_COL, MFR_COL, SIZE_COL,
    { key: 'damage', label: 'Damage', format: fmtInt, higherIsBetter: true },
    { key: 'blast_radius', label: 'Blast', format: fmtDec1, higherIsBetter: true },
    { key: 'tracking_signal', label: 'Tracking' },
    { key: 'lock_time', label: 'Lock', format: fmtDec1, higherIsBetter: false },
    { key: 'speed', label: 'Speed', format: fmtMS, higherIsBetter: true },
    { key: 'lock_range', label: 'Range', format: fmtM, higherIsBetter: true },
    { key: 'hp', label: 'HP', format: fmtInt, higherIsBetter: true },
    { key: 'mass', label: 'Mass', format: fmtDec1, higherIsBetter: false },
  ],
  sensor: [
...
export const COMPARE_STATS = {
  ...
  missile: [
    ...
    { key: 'lock_range', label: 'Range', suffix: ' m', higher: true },
    { key: 'hp', label: 'HP', higher: true },
    { key: 'mass', label: 'Mass', suffix: ' kg', lower: true },
  ],
  sensor: [
