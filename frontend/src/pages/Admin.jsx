...
import { RefreshCw, Globe, Play, AlertCircle, Ticket, Copy, Check, Trash2, FlaskConical, Image, ThumbsUp, X, ExternalLink, DollarSign, Tag } from 'lucide-react'
...
export default function Admin() {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      {/* Game Version Default — flip which version is the public default */}
      <VersionControlPanel />
