        ...
        element={
          <div className="min-h-screen flex">
            ...
            <main id="main-content" className="flex-1 overflow-auto" tabIndex={-1}>
              <div className={location.pathname === '/fps-loadout' ? 'p-4' : location.pathname.startsWith('/components') ? 'max-w-[1600px] mx-auto p-6 md:p-6 pt-16 md:pt-6' : 'max-w-7xl mx-auto p-6 md:p-6 pt-16 md:pt-6'}>
                <ErrorBoundary>
